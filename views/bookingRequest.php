...
<input type="submit" value="Search for Available Pet Walkers/Pet Sitters">
    ...
    <input type="hidden" name="service_type" value="<?= htmlspecialchars($selected_service_type) ?>">
    <input type="hidden" name="pet_name" value="<?= isset($_POST['pet_name']) ? htmlspecialchars(implode(", ", $_POST['pet_name'])) : '' ?>">
    <input type="hidden" name="address" value="<?= htmlspecialchars($address) ?>">
    <input type="hidden" name="date" value="<?= isset($_POST['date']) ? htmlspecialchars($_POST['date']) : '' ?>">
    <input type="hidden" name="starttime" value="<?= isset($_POST['starttime']) ? htmlspecialchars($_POST['starttime']) : '' ?>">
    <input type="hidden" name="endtime" value="<?= isset($_POST['endtime']) ? htmlspecialchars($_POST['endtime']) : '' ?>">
    <input type="hidden" name="photo_consent" value="<?= isset($_POST['photo_consent']) ? htmlspecialchars($_POST['photo_consent']) : 'NO' ?>">
    <input type="hidden" name="review_consent" value="<?= isset($_POST['review_consent']) ? htmlspecialchars($_POST['review_consent']) : 'NO' ?>">
